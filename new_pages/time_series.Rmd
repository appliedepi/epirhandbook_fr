...
Box.test(result$resid, type = "Ljung-Box")
...
Pour étudier les termes individuels, nous pouvons extraire la régression binomiale négative originale du paquet **trending** en utilisant `get_model()` et la passer au fonction `tidy()` du paquetage **broom** pour récupérer les estimations exponentielles et lesintervalles de confiance associés.  
