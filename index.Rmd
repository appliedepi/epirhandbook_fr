...
**Utilisation** : Ce manuel a été utilisé **plus d'un million de fois par 300 000 personnes** dans le monde entier.

**Objectif:** Servir de manuel de référence rapide du code R (en ligne et **[Télécharger le manuel et les données](#date_used)**) avec des exemples centrés sur la tâche qui traitent des problèmes épidémiologiques courants.  

**Essayez nos **[tutoriels interactifs gratuits](https://www.appliedepi.org/tutorial/)** ou notre **[cours d'introduction](https://www.appliedepi.org/live/)** synchrone et virtuel utilisé par les CDC américains, l'OMS et plus de 75 autres agences de santé et programmes de formation à l'épidémiologie sur le terrain dans le monde entier.  

**Langues:** [Espagnol (Español)](https://epirhandbook.com/es/), [Vietnamien (Tiếng Việt)](https://epirhandbook.com/vn/), [Japonais (日本)](https://epirhandbook.com/jp/), [Turc (Türkçe)](https://epirhandbook.com/tr/)  
[Francais](https://epirhandbook.com/fr/)
[Portugais](https://epirhandbook.com/pt/)
...
* Vous pouvez suivre avec les données d'exemple de le chapitre**[Télécharger le manuel et les données](#date_used)**.  

**Version hors ligne**  

Voir les instructions de la page [Télécharger le manuel et les données](#date_used).  
